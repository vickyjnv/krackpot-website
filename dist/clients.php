...
<body>
    <nav class="navbar navbar-clients" id="toggle-nav">
        <?php include('includes/sidebar.php'); ?>
    </nav>

    <div class="clients-section section-default-styling">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item container active">
                        <div class="row">
                            ...
                            <div class="col-xl-5 col-lg-5 col-md-5 offset-1 section-mobile-hide">
                                <div class="section-info animated fadeInRight ">
                                    <img src="images/clients.svg" alt="about" class="section-info-img">
                    ...
                    <div class="carousel-item ">
                        <div class="section-info-clients container-fluid animated fadeInRight">

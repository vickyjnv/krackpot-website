                                            ...
                                            <div class="col-12 second-section section-info-main">
                                                <div class=" animated fadeInRight">
                                                    <p class="section-info-description"><span class="gap">
                                                            ...
                                                            through simplified user interaction designs. In this
                                                            multi-channel
                                                            world,
                                                            companies need innovative ideas to connect with their
                                                            audience;
                                                            that’s
                                                            where
                                                        ...
                                                        <span class="gap">
                                                            We build digital products and experiences that create
                                                            lasting value
                                                            and
                                                            sustainable growth for modern businesses. With strong Design
                                                            and
                                                            Digital
                                                            DNA, Krackpot commits itself to amaze you with Creative
                                                            Digital
                                                            ideas
                                                            fullfilling your Digital Marketing needs. Be it Website,
                                                            Mobile App
                                                            or
                                                            Social Media, we’ve got it all. Our creative digital
                                                            products have
                                                            proved to
                                                            deliver performance over the years and we promise to
                                                            continue to do
                                                            so.
                                                        </span>
                                                    </p>
